...
`).filter(e=>e.trim().length>0).map(e=>`<li>${e.replace(/^[•\-\*]\s*/,``)}</li>`).join(``);return`
    <div style="font-family: Arial, sans-serif; color: #000; width: 100%; max-width: 210mm; margin: 0 auto; padding: 10mm; background-color: #fff; border: 1px solid #d1d5db; box-sizing: border-box; page-break-inside: avoid;">
      <!-- Header -->
